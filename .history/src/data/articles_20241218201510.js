...
function article_2() {
	return {
		...
		description: "Understand the useref hook.",
		style: ``,
		keywords: ["React", "HOOKS", "FRONT END", "OPUDU TAMARAPREYE"],
		body: (
			<React.Fragment>
				<div className="article-content">
					<a
						href="https://splashdev.hashnode.dev/useref-what-the-heck-is-it"
						target="_blank"
						rel="noopener noreferrer"
						className="article-link"
					>
						Read the full article: WHAT THE HECK IS IT?
					</a>
				</div>
			</React.Fragment>
		),
